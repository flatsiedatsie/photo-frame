...
cp *.py manifest.json LICENSE README.md demo_photo.jpg demo_photo2.jpg demo_photo3.jpg demo_photo4.jpg package/
cp -r pkg lib audio localsend css images js views package/
